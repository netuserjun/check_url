            ...
            #	download(url_decode,"tmp.zip")
                        ...
                        if result0 == '444444\n' or result0 == '999999\n':
                                ...
                                if result2 == '666666\n':
                                        ...
                                        string11 = '----- 세부 사항 -----,'
                                        string12 = '해시값 비교,알려진 악성코드의 해시값과 일치하는 항목이 없습니다.,'
                                        string13 = '파일 분석,68개의 백신이 분석한 결과 알려진 악성코드가 검출되지 않았습니다.\n'
                                        string14 = string6 + string10 + string11 + string12 + string13
                                        client_socket.sendall(string14.encode())
                                        time.sleep(1)
