...
if 'html' not in content_type:
	...
	if int(size1) >= 10000000:
		...
		test1_data = 'fafaebe042ba9c59b2c3f65f43774cdb5369f838469e133a7c26e824f6d20cc6'

		hash_list = [md5_data, test1_data]
		result_response_code = []
		for i in hash_list:
			params = {'apikey' : api_key, 'resource' : i}
			response = requests.get(total_url, params=params)
			result = response.json()
			result_response_code.append(result.get('response_code'))

		if result_response_code[:] == [0,0]:
